$(document).on("pageshow","#atletaficha",function(event, ui){
    ...
    $("#liGuardarOtros").click(function(){
        $.mobile.changePage("otrosdatos.html",{ transition : "fade" });
    });
    ...
    $.ajax({
        ...
        beforeSend:function(){
            ...
            $.each( aFicha, function( i, value ) { 
                document.formFicha.cedula.value=value['vcCedula'];
                document.formFicha.fechanac.value=value['dFechaNac'];
                document.formFicha.responsable.value=value['vcAlias'];
                switch(value['vcSexo']){
                    case '0':
    ...
    $("#liGuardarFicha").click(function(){
        ...
        if(sIdentificador!="50104608081"){
            var sAlias=$("#responsable").val();
            var sFechaNac=$("#fechanac").val();
            var sSexo=$("#slcSexo").val();
            var sAltura=$("#cedula").val();
