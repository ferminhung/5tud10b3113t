...
$(document).on("pageshow","#panel",function(event, ui){
    ...
    document.getElementById("liWOD").className = "btn-burbit-rosa";
    document.getElementById("liPagos").className = "btn-burbit-rosa";
    document.getElementById("liMarcas").className = "btn-burbit-rosa";
    document.getElementById("liPerfil").className = "btn-burbit-rosa";
    document.getElementById("liReservas").className = "btn-burbit-rosa";
