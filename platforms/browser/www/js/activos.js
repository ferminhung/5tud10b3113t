$(document).on("pageshow","#activos",function(event, ui){
   ...
   $.ajax({
        data:{
            sCodigoWebPhp:sIdentificador, Mandato:'NominaActivos'
        },
        url:globalURL,
        method:'POST',
        beforeSend:function(){
...
function desactivar(id, sIdentificador, i){
     $.ajax({
        data:{
            sCodigoWebPhp:sIdentificador, sIdPhp:id, Mandato:'DesActivarAlumno'
        },
        url:globalURL,
        method:'POST',
        beforeSend:function(){
...
function activar(id, sIdentificador, i){
     $.ajax({
        data:{
            sCodigoWebPhp:sIdentificador, sIdPhp:id, Mandato:'ActivarAlumno'
        },
        url:globalURL,
        method:'POST',
        beforeSend:function(){
